...
export const TOOLS: Tool[] = [
  ...
  { id: 'ai-hub-studio', name: 'AI Hub Studio (Fine-Tune & Flow Automation)', categories: ['ai'], description: 'Local AI workspace featuring ChatGPT-style chat, Fine-Tune QLoRA recipe builder, side-by-side benchmark evaluator, and interactive local AI flow automations.', icon: 'Bot', run: async (i) => i, component: AIHubStudio },
