...
export const TOOLS: Tool[] = [
  ...
  { id: 'ai-hub-studio', name: 'AI Hub Studio (Fine-Tune & Flow Automation)', categories: ['ai'], description: 'Local AI workspace featuring ChatGPT-style chat, HuggingFace Model Hub, Advanced Multi-Method Fine-Tuning (QLoRA/LoRA/Full/Prefix/Adapter/DPO), side-by-side benchmark evaluator, and interactive local AI flow automations.', icon: 'Bot', run: async (i) => i, component: AIHubStudio },
  { id: 'ai-model-manager', name: 'Model Settings & Storage Manager', categories: ['ai'], description: 'Manage local Ollama model weights, delete unused models, inspect Modelfiles, copy aliases, and control VRAM.', icon: 'Settings', run: async (i) => i, component: AIHubStudio },
