...
`;
  ...
  return (
    <div className="space-y-6 animate-fadeIn text-left">
      ...
      <div className="bg-[#18191B] border border-[#2A2D30] p-5 rounded-2xl space-y-4 shadow-lg">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1.5">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-xl bg-[#3C6B4D]/15 text-[#3C6B4D] border border-[#3C6B4D]/30 text-[11px] font-bold uppercase tracking-wider w-fit">
              <Wand2 size={13} className="shrink-0 text-[#3C6B4D]" />
              <span>Prompt Framework Architect &amp; Agent Skill Creator ({allSkills.length} Skills)</span>
            </div>
            <h2 className="text-xl font-black text-[#ECEBE9] tracking-tight">Prompt Engineering Lab</h2>
            <p className="text-[#72706C] text-xs leading-relaxed max-w-xl">Design system personas, save &amp; activate custom agent skills in DomoDomo, and download .agents ZIP bundles.</p>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 pt-3 border-t border-[#2A2D30]/60">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-3.5 py-2 bg-[#111213] border border-[#2A2D30] text-[#ECEBE9] hover:border-[#3C6B4D] text-xs font-bold rounded-xl transition-all flex items-center gap-1.5"
            ...
            <button
              ...
              className="px-3.5 py-2 bg-[#111213] border border-[#2A2D30] hover:text-[#ECEBE9] text-[#A3A09B] text-xs font-bold rounded-xl transition-all flex items-center gap-1.5"
            >
      ...
      {/* Sub-Navigation Tabs */}
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 bg-[#18191B] p-1.5 rounded-2xl border border-[#2A2D30]">
        <button
          onClick={() => setActiveTab('workspace')}
          className={`px-3 py-2 rounded-xl text-xs font-extrabold flex items-center justify-center gap-2 transition-all cursor-pointer truncate ${
            activeTab === 'workspace'
              ? 'bg-[#3C6B4D] text-white shadow-md'
              : 'bg-transparent text-[#72706C] hover:text-[#ECEBE9]'
          }`}
        >
          <Wand2 size={13} /> <span className="truncate">1. Prompt Workspace</span>
        </button>
        ...
        >
          <BookOpen size={13} /> <span className="truncate">2. Frameworks</span>
        </button>
        ...
        >
          <Award size={13} className="text-amber-400 shrink-0" /> <span className="truncate">3. Skill Library ({allSkills.length})</span>
        </button>
        ...
        >
          <Archive size={13} className="text-amber-400 shrink-0" /> <span className="truncate">4. Exporter</span>
        </button>

        <button
          onClick={() => setActiveTab('audit')}
          className={`px-3 py-2 rounded-xl text-xs font-extrabold flex items-center justify-center gap-2 transition-all cursor-pointer col-span-2 sm:col-span-1 truncate ${
            activeTab === 'audit'
              ? 'bg-[#3C6B4D] text-white shadow-md'
