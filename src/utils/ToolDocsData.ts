  ...
  ai: {
    ...
    list: [
      ...
      },
      {
        ...
        howItWorks: '1. Select any of the 18 dedicated AI Hub tools from the categorized sidebar or mobile drawer. 2. Processes all inputs, vector distances, canvas pixel data, and AST patches 100% client-side with optional local Ollama HTTP API streaming (port 11434) and HuggingFace Hub model discovery. 3. Provides 1-click model downloads, multi-method fine-tuning package exports, and zero cloud server dependencies.',
        technicalSpecs: '100% client-side offline execution with optional HuggingFace token integration. Connects to Ollama REST endpoints (/api/generate, /api/pull, /api/delete, /api/show, /api/copy, /api/tags), features SVG Canvas graphics, IndexedDB workflow persistence, and custom Python/Shell/JSON export.'
      },
      {
        id: 'ai-model-manager',
